...
![Inertia](https://img.shields.io/badge/Inertia.js-111827?style=flat)
...
- **OrgUNS – Agenda Android**  
  **Kotlin/Android + Firebase**  
  Enfoque: auth, persistencia/sync, pantallas limpias y rápidas.

- **Noticiero / Web App**  
  **Laravel + React + despliegue en Cloud**  
  Enfoque: publicación/gestión de contenido + deploy y configuración.
